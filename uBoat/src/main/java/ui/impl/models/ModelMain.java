...
public class ModelMain implements Input {
    ...
    @Override
    public void readMachineFromXMLFile(String path) throws JAXBException, InvalidRotorException, IOException, InvalidReflectorException, InvalidMachineException, InvalidDecipherException, InvalidABCException {
