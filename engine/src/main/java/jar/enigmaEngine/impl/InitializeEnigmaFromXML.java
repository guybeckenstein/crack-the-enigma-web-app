...
import jar.enigmaEngine.CreateAndValidateEnigmaComponentsImpl;
import jar.enigmaEngine.exceptions.*;
import jar.enigmaEngine.interfaces.*;
import jar.enigmaEngine.schemaBinding.*;
...
public class InitializeEnigmaFromXML implements InitializeEnigma {
    ...
    private static CTEEnigma getSourceFromXML(String path) throws IOException, JAXBException {
        ...
        JAXBContext jaxbContext = JAXBContext.newInstance("jar.enigmaEngine.schemaBinding");
    ...
    private EnigmaEngineImpl getEnigmaEngine(CTEEnigma xmlOutput) throws RuntimeException, InvalidABCException, InvalidReflectorException, InvalidRotorException, InvalidMachineException {
        // Machine
        ...
        HashMap<Integer, RotorImpl> rotors = (HashMap<Integer, RotorImpl>)importCTERotors(cteRotors, new HashMap<>());
        ...
        HashMap<Reflector.ReflectorID, ReflectorImpl> reflectors = (HashMap<Reflector.ReflectorID, ReflectorImpl>)importCTEReflectors(cteReflectors, new HashMap<>());
    ...
    public Pair<XmlDTO, XmlToServletDTO> getBriefXMLFromSource(String path, EnigmaEngine newEnigmaEngine) throws JAXBException, IOException, InvalidDecipherException, InvalidBattlefieldException {
        ...
        XmlToServletDTO xmlToServletDTO = new XmlToServletDTO(rotorsFromXML, reflectorsFromXML, ABCFromXML, numAllies, difficulty, battlefieldTitle);
