...
public class EnigmaEngineImpl implements EnigmaEngine, Serializable {
    ...
    private final Map<Reflector.ReflectorID, ReflectorImpl> reflectors;
    ...
    private ReflectorImpl selectedReflector;
    ...
    public EnigmaEngineImpl(HashMap<Integer, RotorImpl> rotors, HashMap<Reflector.ReflectorID, ReflectorImpl> reflectors, PlugBoardImpl plugBoard, String abc) {
        this.rotors = rotors;
    ...
    public Map<Integer, RotorImpl> getRotors() {
        return this.rotors;
    }
