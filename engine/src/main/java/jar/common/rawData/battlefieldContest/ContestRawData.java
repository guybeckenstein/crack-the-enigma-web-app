...
public class ContestRawData {
    ...
    public ContestRawData(Battlefield battlefield) {
        this.title = new SimpleStringProperty(battlefield.getTitle());
        this.username = new SimpleStringProperty(battlefield.getUsername());
        this.status = new SimpleStringProperty(battlefield.getStatus().toString());
        this.difficulty = new SimpleStringProperty(battlefield.getDifficulty().toString());
        this.teamsRegistered = new SimpleStringProperty(battlefield.getTeamsRegistered());
    }
